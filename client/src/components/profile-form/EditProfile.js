...
const [displaySocialInputs, toggleSocialnputs] = useState(false);
...
useEffect(() => {
  ...
  setFormData({
        ...
        location: loading || profile.location ? '': profile.website,
  ...
  createProfile(formData, history, true)
     ...
     return (
      ...
      <form className="form" onSubmit={ e => onSubmit(e)}>
        ...
        <div className="my-2">
          <button onClick={() =>toggleSocialnputs(!displaySocialInputs)} type="button" className="btn btn-light">
